...
import 'boy_hindi_model.dart';
export 'boy_hindi_model.dart';

class BoyHindiWidget extends StatefulWidget {
  const BoyHindiWidget({super.key});

  @override
  State<BoyHindiWidget> createState() => _BoyHindiWidgetState();
}

class _BoyHindiWidgetState extends State<BoyHindiWidget> {
  late BoyHindiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoyHindiModel());
