...
import 'boy_tamil_model.dart';
export 'boy_tamil_model.dart';

class BoyTamilWidget extends StatefulWidget {
  const BoyTamilWidget({super.key});

  @override
  State<BoyTamilWidget> createState() => _BoyTamilWidgetState();
}

class _BoyTamilWidgetState extends State<BoyTamilWidget> {
  late BoyTamilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoyTamilModel());
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.soundPlayer1!
                              .setAsset('assets/audios/Tamilbadtouch.wav')
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.soundPlayer2!
                              .setAsset('assets/audios/Tamilgoodtouch.wav')
