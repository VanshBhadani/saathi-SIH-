...
import 'girl_tamil_model.dart';
export 'girl_tamil_model.dart';

class GirlTamilWidget extends StatefulWidget {
  const GirlTamilWidget({
    super.key,
    double? showOverlay,
    double? image,
  ...
  @override
  State<GirlTamilWidget> createState() => _GirlTamilWidgetState();
}

class _GirlTamilWidgetState extends State<GirlTamilWidget> {
  late GirlTamilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GirlTamilModel());
