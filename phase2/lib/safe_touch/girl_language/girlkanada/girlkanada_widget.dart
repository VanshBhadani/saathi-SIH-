...
import 'girlkanada_model.dart';
export 'girlkanada_model.dart';

class GirlkanadaWidget extends StatefulWidget {
  const GirlkanadaWidget({
    super.key,
    double? showOverlay,
    double? image,
  ...
  @override
  State<GirlkanadaWidget> createState() => _GirlkanadaWidgetState();
}

class _GirlkanadaWidgetState extends State<GirlkanadaWidget> {
  late GirlkanadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GirlkanadaModel());
