...
import 'boykanada_model.dart';
export 'boykanada_model.dart';

class BoykanadaWidget extends StatefulWidget {
  const BoykanadaWidget({super.key});

  @override
  State<BoykanadaWidget> createState() => _BoykanadaWidgetState();
}

class _BoykanadaWidgetState extends State<BoykanadaWidget> {
  late BoykanadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoykanadaModel());
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.soundPlayer1!
                              .setAsset('assets/audios/kannadabadtouch.wav')
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.soundPlayer2!
                              .setAsset('assets/audios/Kannadagoodtouch.wav')
