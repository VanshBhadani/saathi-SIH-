...
import 'girl_e_n_g_model.dart';
export 'girl_e_n_g_model.dart';

class GirlENGWidget extends StatefulWidget {
  const GirlENGWidget({
    super.key,
    double? showOverlay,
    double? image,
  ...
  @override
  State<GirlENGWidget> createState() => _GirlENGWidgetState();
}

class _GirlENGWidgetState extends State<GirlENGWidget> {
  late GirlENGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GirlENGModel());
